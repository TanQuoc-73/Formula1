...
// Utility helper, bạn có thể thay thế bằng hàm classnames hoặc các util khác
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-pointer select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-blue-100",
    )}
    {...props}
  >
